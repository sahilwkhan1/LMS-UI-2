...
export const reviews = [
  {
    name: "Alok Kumar",
    avatar: Avatar,
    profession: "Developer  | G7CR",
    comment:
      "I had the pleasure of exploring LMS, a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience, as the website offers a comprehensive selection of courses that cater to different skill levels and interests. If you're looking to enhance your knowledge and skills in the tech industry, I highly recommend checking out LMS!",
  },
  {
    name: "Irshad",
    avatar: Avatar,
  ...
  },
  {
    ...
    profession: "Developer  | G7CR",
    comment:
      "I had the pleasure of exploring LMS, a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience",
  },
  {
    name: "Rashmi",
    avatar: Avatar,
  ...
  },
  {
    ...
    profession: "Developer  | G7CR",
    comment:
      "LMS focuses on practical applications rather than just teaching the theory behind programming languages or frameworks. I took a lesson on creating a web marketplace using React JS, and it was very helpful in teaching me the different stages involved in creating a project from start to finish. Overall, I highly recommend LMS to anyone looking to improve their programming skills and build practical projects. LMS is a great resource that will help you take your skills to the next level.",
  },
];
