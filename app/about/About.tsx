    ...
    <div className="text-black dark:text-white">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than LMS, the premier programming community dedicated to
          helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of LMS, I know firsthand the challenges that
          come with learning and growing in the programming industry.
          That&apos;s why I created LMS &ndash; to provide new programmers with
          ...
          <br />
          <br />
          At LMS, we believe that price should never be a barrier to achieving
          your dreams. That&apos;s why our courses are priced low &ndash; so
          that anyone, regardless of their financial situation, can access the
          tools and knowledge they need to succeed.
          <br />
          <br />
          But LMS is more than just a community &ndash; we&apos;re a family. Our
          ...
          <br />
          <br />
          With LMS by your side, there&apos;s nothing standing between you and
          ...
          <br />
          <br />
          So what are you waiting for? Join the LMS family today and let&apos;s
        ...
        <h5 className="text-[18px] font-Poppins">Founder and CEO of LMS</h5>
        <br />
        <br />
        <br />
      </div>
